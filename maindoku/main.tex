...
Was wir allso testen ist die effizienz der Sourcecode zu Bytecode
Compiler. Diese Technischen Details werden sp\"ater in dieser Arbeit verwendet.
...
die speziell f\"ur diese Hardware den Code anpassen.
\\
...
vielen Anwendungsgebieten, insbesondere Enterprice Applikationen.
...
f\"ur die JVM geschrieben wurde. Im Vordergrund der Entwicklung standen
